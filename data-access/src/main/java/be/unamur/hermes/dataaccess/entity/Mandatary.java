...
public class Mandatary {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Mandatary)) return false;
        Mandatary mandatary = (Mandatary) o;
        return id == mandatary.id &&
                Objects.equals(citizen, mandatary.citizen) &&
                Objects.equals(company, mandatary.company) &&
                Objects.equals(role, mandatary.role);
    }
